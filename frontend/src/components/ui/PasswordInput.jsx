  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className={cn(
          'w-full rounded-lg border bg-white px-3.5 py-2.5 pr-10 text-sm text-ink-800 placeholder:text-slate-400',
      ...
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 transition-colors hover:text-ink-600"
